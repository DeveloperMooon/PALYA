        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div className="rounded-3xl border border-emerald-100 bg-emerald-50/60 p-7 sm:p-8">
              ...
              <button
                type="button"
                onClick={() => onNavigate('early-detection')}
              ...
              {[
                {
                  ...
                  text: 'Animal histories remain organized and accessible.',
                },
                {
                  icon: HeartPulse,
                  title: 'Early Screening',
                  text: 'Explainable species-specific symptom screening.',
                },
                {
                  icon: Stethoscope,
                  title: 'Vet Verification',
                  text: 'Clinical escalation with verified visit evidence.',
                },
                {
                  icon: Activity,
                  title: 'AMU Stewardship',
                  text: 'Treatment and antimicrobial-use visibility.',
                },
                {
                  icon: Bell,
                  title: 'Withdrawal Awareness',
                  text: 'Active withdrawal monitoring remains visible.',
                },
                {
                  icon: ShieldCheck,
                  title: 'Food Safety',
                  text: 'Treatment workflow extends toward clearance.',
                },
              ].map((feature) => {
                const Icon = feature.icon;
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            <div className="md:col-span-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xl font-black">PALYA</p>
